...
public class ShipsViewerPopup extends DraggablePanel {
    private int column = 0;

    public ShipsViewerPopup(final List<ShipDTO> ships, final String title) {
        ...
        new DelayIterator(0, ships.size(), 1) {

            @Override
            public void executeStep() {
                final ShipDTO ship = ships.get(ITERATE_INDEX);
                if (column == 0) {
