...
public class RichTextToolbar
    ...
    private static final String CSS_ROOT_NAME = "myRichTextToolbar";
    ...
    private class EventHandler implements ClickHandler, KeyUpHandler, ChangeHandler {
        public void onClick(final ClickEvent event) {
            if (event.getSource().equals(bold)) {
                ...
                final String url = Window.prompt(GUI_DIALOG_INSERTURL, "http://");
                if (url != null) {
                    if (isHTMLMode()) {
                ...
                final String url = Window.prompt(GUI_DIALOG_IMAGEURL, "http://");
                if (url != null) {
                    if (isHTMLMode()) {
...
//			}
     ...
     */
    public static native JsArrayString getSelection(final Element elem) /*-{
        var txt = "";
        var pos = 0;
        var range;
        var parentElement;
