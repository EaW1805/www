...
import empire.webapp.client.events.map.MapEventManager;
...
import empire.webapp.client.gui.eventHandlers.DelEventHandlerAbstract;
import empire.webapp.client.views.frames.BattleFrame;
import empire.webapp.client.views.layout.MapsView;
import empire.webapp.client.views.tutorial.TutorialStore;
...
import empire.webapp.shared.stores.util.JumpOffCoordinates1804;
import empire.webapp.shared.stores.util.JumpOffCoordinates1805;
