...
public class BrigadeInfoMini
    ...
    private final Image[] battImages = new Image[7];
...
//            battImages[index].setEmpireBattalionDTO(battalion);
            ...
            if (brigade.getNationId() == BaseStore.getInstance().getNationId()) {
    ...
    private void addOverViewPanelToImage(final Image armyTypeImg) {
