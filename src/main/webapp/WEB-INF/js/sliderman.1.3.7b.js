 ...
 *
 * (c) 2010-2011 Devtrix. All rights reserved. http://www.devtrix.net/SlidermanSmall/
 **/

var SlidermanSmall = new function () {
    var SlidermanSmall = this;
    ...
    function defineObject(t, o) {
        ...
        if (o) {
            ...
            } else o.name = 'SlidermanSmall-nameless-object-' + definedObjects[t].length;
            if (n >= 0) definedObjects[t][n] = o;
            else definedObjects[t].push(o);
        }
    }//defineObjects
    SlidermanSmall.easing = function (e) {
        defineObject('easing', e);
    }
    SlidermanSmall.order = function (e) {
        defineObject('order', e);
    }
    SlidermanSmall.effect = function (e) {
    ...
    function EffectObject(a) {
        ...
        if (!a.name) a.name = 'SlidermanSmall-nameless-effect-' + _EffectObject++;
    ...
    SlidermanSmall.slider = function (parameters) {
        setOpacityInit();
        ...
        //CONTAINERS
        var sliderCont = newElement('DIV', {width:display.width, height:display.height, position:'relative'});
        ...
        return Slider;
    }//SlidermanSmall.slider


}//SlidermanSmall

/* predefined easing functions */
SlidermanSmall.easing({name:'none', method:function (x) {
    return x;
}});
SlidermanSmall.easing({name:'swing', method:function (x) {
    return -Math.cos(x * Math.PI) / 2 + 0.5;
}});
SlidermanSmall.easing({name:'wave', method:function (t) {
    return ((Math.cos((1 - t) * 3 * Math.PI + 2 * Math.PI)) * 0.5 + 0.5 + t) / 2;
}});
SlidermanSmall.easing({name:'bounce', method:function (t) {
    return 1 - Math.abs(Math.cos((1 - t) * (2.5 + t * t * 3) * Math.PI + 0.5 * Math.PI) * (1 - t));
}});
/* predefined order functions */
SlidermanSmall.order({name:'straight', method:function (e) {
...
SlidermanSmall.order({name:'swirl', method:function (e) {
    var cols = e.cols, rows = e.rows, road = e.road, count = e.count;
    var a = [], i = 0, c = 0, r = 0, cl = cols - 1, rl = rows - 1, il = count - 1, cr;
...
SlidermanSmall.order({name:'snake', method:function (e) {
    var cols = e.cols, rows = e.rows, road = e.road, count = e.count;
    var a = [], i = 0, c = 0, r = 0, cl = cols - 1, rl = rows - 1, il = count - 1, cr;
    var courses, course = 0;
    switch (road) {
...
SlidermanSmall.order({name:'straight_stairs', method:function (e) {
    var cols = e.cols, rows = e.rows, road = e.road, count = e.count;
    var a = [], i = 0, c = 0, r = 0, cl = cols - 1, rl = rows - 1, il = count - 1, cr;
    switch (road) {
        case 'BL':
...
SlidermanSmall.order({name:'square', method:function (effect) {
...
SlidermanSmall.order({name:'rectangle', method:function (effect) {
...
SlidermanSmall.order({name:'random', method:function (effect) {
    var a = [], tmp = [], r, c, i;
...
/* predefined effects */
SlidermanSmall.effect({name:'fade', fade:true, duration:400});
SlidermanSmall.effect({name:'move', left:true, move:true, duration:400});
SlidermanSmall.effect({name:'stairs', cols:7, rows:5, delay:30, order:'straight_stairs', road:'BL', fade:true});
SlidermanSmall.effect({name:'blinds', cols:10, delay:100, duration:400, order:'straight', right:true, zoom:true, fade:true});
SlidermanSmall.effect({name:'rain', cols:10, delay:100, duration:400, order:'straight', top:true, fade:true});
