...
<jsp:useBean id="userGameResults" scope="request" type="java.util.List<com.eaw1805.data.model.UserGame>"/>
...
<c:forEach items="${userGameResults}" var="userGameResult" varStatus="status">
    <jsp:useBean id="userGameResult" type="com.eaw1805.data.model.UserGame"/>

    <div id="userGameResult_container_${status.index}" style="position: fixed;display: none; z-index:5;" viewed="0"
        ...
        <article>
            <section class="gameInfo" style="opacity: 1 !important; border: 0;">
                ...
                <%} else { %>
                <c:choose>
                    <c:when test="${userGameResult.turnDrop > userGameResult.turnPickUp}">
                        <img src="http://static.eaw1805.com/images/panels/gameResults/dropOut.png"
                             style="position: absolute; left: 0px; top: 0px; ">
                    </c:when>
                    <c:when test="${userGameResult.game.ended}">
                        <c:choose>
                            <c:when test="${userGameResult.hasWon}">
                                <img src="http://static.eaw1805.com/images/panels/gameResults/winner.png"
                                     style="position: absolute; left: 0px; top: 0px; ">
                            </c:when>
                ...
                <%}%>
                <h1 style="float: left; font-size: 26px ! important; width: 752px; position: absolute; left: 0px; top: 216px; text-align: center;">
