...
<div class="pagehead"
    ...
    <div style="padding-top: 50px; padding-left: 30px;">
        <h1 style="font-size: 38px;
                       width: 410px;
                       text-align: center;">Retrieve Username</h1>
        ...
        <div style="padding-top: 30px;
                    ...
                    font-size: 14px;
                    text-align: justify;">
            Please type in your e-mail and an automated e-mail message will be send to you containing your username.
        </div>
        ...
        <div class="formbody">
            ...
            <form:form commandName="user" method="POST" action='forgot_username'>
            <label for="email"
            ...
            <p class="manual" style="clear:both; padding-left: 2px; padding-top: 20px;">
            ...
            <label class='submit_btn'
                ...
                <input name="submit"
                       type="image"
                       src="http://static.eaw1805.com/images/site/signup/RetrieveUsernameOff.png"
                       onmouseover="this.src='http://static.eaw1805.com/images/site/signup/RetrieveUsernamerhov.png'"
                       onmouseout="this.src='http://static.eaw1805.com/images/site/signup/RetrieveUsernameOff.png'"
