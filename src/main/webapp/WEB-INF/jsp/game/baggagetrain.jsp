...
<jsp:useBean id="baggagetrain" scope="request" type="com.eaw1805.data.model.economy.BaggageTrain"/>

<h2 style="padding-left: 40px; padding-top: 20px;">Baggage train ${baggagetrain.name} Balance Sheet</h2>
