...
<div id="wrap">
<div id="mainClear">
<div id="header" style="height: 291px;">
    <div class="eaw-logo-clear" onclick="window.location='http://www.eaw1805.com/home';"></div>
</div>
<security:authorize ifNotGranted="ROLE_ANONYMOUS">
...
<div class="site">
    ...
    <div class="pagehead"
         style="background-image: url('http://static.eaw1805.com/images/site/HallOfFamePanelsBig.png');
                        ...
                        margin-top: -80px;
                        clear: both;
                        background-size: 950px 974px;
                        height: 974px;">
        <div class="topbox" style="margin-top: -230px;">
            <ul>
        ...
        <security:authorize ifAnyGranted="ROLE_ANONYMOUS">
            <div class="loginbox" style="margin-top: -224px;margin-right: 58px;">
                    <span class="login">
        ...
        <security:authorize ifNotGranted="ROLE_ANONYMOUS">
            <div class="userbox" style="margin-top: -224px;margin-right: 95px;">
                <ul class="usernav">
                    <li>
			        ...
			        <button value="" name="Submit" type="submit" style="margin-top: -223px; margin-right: 62px;"
