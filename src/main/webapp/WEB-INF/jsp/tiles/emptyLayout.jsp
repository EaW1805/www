...
<div class="site">
    ...
    <div class="emptyhead">
        ...
        <security:authorize ifAnyGranted="ROLE_ANONYMOUS">
            <div class="loginbox" style="margin-top: -63px;margin-right: 75px;">
                    <span class="login">
        ...
        <security:authorize ifNotGranted="ROLE_ANONYMOUS">
            <div class="userbox" style="margin-top: -63px;margin-right: 75px;">
                <ul class="usernav">
                    <li>
			        ...
			        <button value="" name="Submit" type="submit" style="margin-top: -62px; margin-right: 42px;"
