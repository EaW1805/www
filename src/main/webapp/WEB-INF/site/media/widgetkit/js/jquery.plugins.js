...
(function (f, e, a) {
    ...
    !e[k] && e.addEventListener && (e.addEventListener("DOMContentLoaded",
            function q() {
...
(function (f) {
    ...
    f.extend(f.easing, {def:"easeOutQuad", swing:function (e, a, c, b, d) {
        ...
        return(a /=
                d / 2) < 1 ? b / 2 * a * a * a + c : b / 2 * ((a -= 2) * a * a + 2) + c
...
(function (f) {
    ...
    f.event.special.mousewheel = {setup:function () {
        if (this.addEventListener)for (var c =
                a.length; c;)this.addEventListener(a[--c], e, !1); else this.onmousewheel = e
    }, teardown:function () {
